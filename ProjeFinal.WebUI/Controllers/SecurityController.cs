...
using ProjeFinal.WebUI.Identity;
using ProjeFinal.WebUI.Models.Security;
using ProjeFinal.WebUI.Services;
        ...
        public async Task<IActionResult> Register(RegisterViewModel registerViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    emailAddressesFrom.Add(new EmailAddress { Name = "Proje Final Bilgilendirme", Address = _configuration.GetSection("EmailConfiguration").GetSection("EmailFrom").Value });
